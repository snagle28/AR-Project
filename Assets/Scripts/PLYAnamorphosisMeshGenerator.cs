...
public class PLYAnamorphosisMeshGenerator : MonoBehaviour
{
    ...
    public void GenerateFromPLY()
    {
        ...
        {
            Debug.LogError("AhaPointView와 PLY File을 연결해야 합니다.");
            return;
        }
    ...
    void CreateQuadMesh(List<Vector3> points)
    {
        ...
        // AhaPointView 방향으로 quad를 orient.
        // billboardCamera(HMD 각도)에 의존하지 않으므로
        // generateOnStart=true 시에도 항상 올바른 방향이 보장됨.
